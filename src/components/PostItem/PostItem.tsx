...
const PostItem: FC<PostItemProps> = ({ id, img, name, code ,startDate, endDate, status }) => {
    console.log(new Date().toISOString())
  return (
    <div className="h-full w-full grid grid-cols-4 gap-4 text-base">
      <div className="w-full h-[200px]">
        <img className="w-full h-full object-cover  rounded-lg" src={img} alt="postitem" />
      </div>
      <div className="col-span-2 ">
        ...
        <div className="flex justify-start gap-12 text-center">
            <div className="text-center">
                ...
                <StatusBox status={status} title={PostTitleMapping.get(status || "")}></StatusBox>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
                ...
                <div className="text__main-color p-2">{formatShortDate(startDate)}</div>
            </div>
            <div className="text-center">
                <div className="text__title">Ngày hết hạn</div>
                <div className="text__main-color p-2">{formatShortDate(endDate)}</div>
            </div>
        </div>
      </div>
...
PostItem.defaultProps = {
    img:
      'https://cdn.vntrip.vn/cam-nang/wp-content/uploads/2017/07/ho-hoan-kiem-3.jpg',
    name:
        'Cần tìm bạn ở ghép chung phòng quận 4',
    code:
        '2022101',
    startDate:
        '2023-09-29T19:57:50.468Z',
    endDate:
        '2023-09-29T19:57:50.468Z',
    status:
        'success'
